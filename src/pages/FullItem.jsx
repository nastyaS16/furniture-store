...
const FullItem = () => {
  ...
  const onClickFavourite = () => {
    ...
    heart
      ? dispath(removeFavouriteItem(id))
      : dispath(addFavouriteItem(itemHeart));
  };
      ...
      <div className="container">
        ...
        <div className="full-item">
          ...
          <div className="full-description">
            ...
            <p className="text">
              STRANDMON wing chairs, sofas and foot stools are inspired by an
              IKEA wing chair from the 50's. But we put higher demands on our
              furniture today. That’s why we’ve made sure STRANDMON can take a
              person that sits and gets up at least 50,000 times. That’s once a
              day for 136 years.
            </p>
            {count > 0 ? (
